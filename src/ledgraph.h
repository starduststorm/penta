...
const std::vector<PixelIndex> kCircleSectionStarts = {70,103,114,81,92}; // sections of circle cooresponding to touch pad numbering
...
const std::vector<PixelIndex> pentaTriangles[] = {
                                    { 0, 1, 2, 3, 4,19,20,21,22,23,65,66,67,68,69, 70}, // last index is tip of triangle
